...
const reports = [
  [
    `本周，是我实习的第一周。刚进入医院的时候，很茫然，不知道要做些什么，对自己的岗位充满期待，对医院充满好奇。领导叫做什么，我们就做什么，最开始的时候是培训。也怕自己没有能够做好相关的工作,带来不好的影响以及麻烦。好在医院给我安排了一位和我年纪相仿的同事带我熟悉工作环境，工作内容。由于我初来乍到，对这个岗位的工作流程还不太熟悉，幸好我的实习负责人耐心的给我讲解了一些（什么工作）需要注意的地方，然后慢慢让我尝试自己做一下，自己去理解，我自己做的过程中，产生了很多疑问，我经常带着我不懂的问题去问负责人，负责人都耐心的教我。这一周的学习内容虽然不是很多，但是最主要的还是尽快适应工作的节奏，以及熟悉工作，我也对我的工作环境以及工作内容有了初步的了解。经过这一周的相处，医院的人也都很好，很好相处，在接下来的时间里，我会更加努力认真的学习，多问多听多学多看，努力的工作。`,
  ...
  [
    `在经历了一周的打杂工作，让我对医院的运作流程以及工作有了一个整体的了解，因此这一周我们的工作内容也有了一个小变化，除了进行简单的技术资料整理， 还有就是如何去做好这个产品方面的设计，我本来以为就要将具体的尺寸用工具测量出来，然后通过autocad画出来就可以了，但是结果并不是想象中那么简单。老板总是叫我一遍又一遍的检查画的图是否还有其他的错误，经过几天的检查，我开始感觉到一整天坐在电脑面前开始有些疲倦，整天面对着电脑，看着那枯燥无谓的图形，我有点开始厌倦了，但是我还是坚持着做着，细心的检查着。就这样我熬过了枯燥的一个星期。`,
  ],
  [
  ...
  [
    "图是弄好了，接下来是开始进行生产，调试。真是毛病重重，错误多多啊!产品刚出来进行调试微出现这样那样的毛病。后来才清楚知道是怎么一回事。不过通过这件事可以学到不少在学校所学不到的知识与经验，原来在设计绘图，这个零件是考虑的并不单单是把图绘出来，还要了解一些关于市场方面的信息，比如说价格，一些常用的毛坯，怎么做起来才方便简洁，如何把他设计成又好又方便的产品。还要考虑在加工过程中出现的误差，还有一些热处理方面的知识等等。如果不想到这些结果会是难以想象的，浪费时间上其次的，最重要的是医院的损失。",
  ],
  [
    `经过一个多月的实习，虽然对医院不是那么的太了解，但是多少不等也有所了解。天天做着一样的事，感觉得无比的枯燥只有自己一个人坐在电脑面前一整天，只有电脑从早到晚的陪者我，觉得好孤独，没有了以前在学校的那种欢声笑语，没有在学校的那种轻松悠闲自在了，有的只是空虚和寂寞。有些时候闲下来就坐在电脑面前发呆，不知道做什么。 就这样一天一天的耗着，感觉除了工作以外，自己的生活中就没有其他的新鲜的事情，或者是值得人去回忆，留念的了，没有了色彩斑斓的生活，有的只是枯燥的工作有些时候都有点冲动想不干了，去换换别的工作，想给累积更多的社会知识和经验，但是想了想还没有那么的冲动，还是在原来的地方老实的呆着。`,
  ],
  [
  ...
  [
    `这一周，我开始深入学习与自己岗位相关工作知识，得到同事的帮助下，我先从规范下手，就是熟悉下当前最专业行业方面的规范，再就是记各种工作相关的必备知识。经过两天的苦研，我终于能基本看懂结构施工图了。经过前期实习后，我大概了解了整个工作程序。
  ...
  [
    ...
    况且我还是个实习的，我想等我经历得更多，对于患者更加的熟悉，有了更多的经验，那么我的业绩也是会名列前茅的，特别是我也是感受到看到我的成绩，其他和我一起来到医院实习的同事，也是更加的努力了，的确别人可以，那么我为什么就不行，其实也是努力，去执行，去多反思把方法用对，业绩的目标是完全可以达成的。`,
  ],
];
